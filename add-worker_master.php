...
{   //$worker_id  = $_POST['worker_id '];
    ...
    $q = mysqli_query($connection, "insert into worker_master (worker_name,worker_photo,worker_gender,worker_email,worker_mobile,worker_documents,worker_details,worker_expertise)values('{$worker_name}','{$worker_photo}','{$worker_gender}','{$worker_email}','{$worker_mobile}','{$worker_documents}','{$worker_details}','{$worker_expertise}')") or die(mysqli_error($connection));
              ...
              <form role="form" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputWorkerName1" name="worker_name" placeholder="Enter Worker Name">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="worker_photo">
                    ...
                    <label for="exampleInputWorkerGender1">Worker Gender</label>
                     <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" id="customRadio1" Value="Male" name="worker_gender">
                          <label for="customRadio1" class="custom-control-label">Male</label>
                     </div>
                     <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" id="customRadio2" Value="Female" name="worker_gender">
                          <label for="customRadio2" class="custom-control-label">Female</label>
                     </div>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputWorkerEmail1">Worker Email</label>
                    <input type="email" class="form-control" id="exampleInputWorkerEmail1" name="worker_email" placeholder="Enter Worker Email">
                  </div> 
                  <div class="form-group">
                    <label for="exampleInputWorkerMobile1">Worker Mobile</label>
                    <input type="number" class="form-control" id="exampleInputWorkerMobile1" name="worker_mobile" placeholder="Enter Worker Mobile">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputWorkerDocuments1">Worker Documents</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="worker_documents">
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                      </div>
                    </div>
                  <div class="form-group">
                    <label for="exampleInputWorkerDetails1">Worker Details</label>
                    <input type="text" class="form-control" id="exampleInputWorkerDetails1" name="worker_details" placeholder="Enter Worker Details">
                  </div>
                  <div class="form-group">
