                  ...
                  <tbody>
                      ...
                      if(isset($_GET['did']))
                      {
                        ...
                        { 
                            ...
                            echo "<td><a href='edit-feedback_master.php?feedback_id={$feedbackrow['feedback_id']}'><img style='width:20px;' src='myimages/edit.png'>Edit</a>|<a href='display-feedback_master.php?did={$feedbackrow['feedback_id']}'><img style='width:20px;' src='myimages/delete.png'>Delete</a><td>";                        
                            echo "</tr>";
                        }
