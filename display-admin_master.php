                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                      ...
                      if(isset($_GET['did']))
                      {
                          ...
                          $deleteq = mysqli_query($connection,"delete from admin_master where admin_id = '{$did}'") or die(mysqli_error($connection));
                          if($deleteq)
                          {
                        ...
                        $selectq = mysqli_query($connection, "select * from admin_master") or die(mysqli_error($connection));
