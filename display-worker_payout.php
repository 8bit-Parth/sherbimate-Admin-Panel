                  ...
                  <tbody>
                      ...
                      if(isset($_GET['did']))
                      {
                        ...
                        { 
                            ...
                            echo "<td><a href='edit-worker_payout.php?worker_payout_id={$workerpayoutrow['worker_payout_id']}'><img style='width:20px;' src='myimages/edit.png'>Edit</a>|<a href='display-worker_payout.php?did={$workerpayoutrow['worker_payout_id']}'><img style='width:20px;' src='myimages/delete.png'>Delete</a><td>";                        
                            echo "</tr>";
                        }
