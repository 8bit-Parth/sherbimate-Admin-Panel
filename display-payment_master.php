                  ...
                  <tbody>
                      ...
                      if(isset($_GET['did']))
                      {
                        ...
                        { 
                            ...
                            echo "<td><a href='edit-payment_master.php?payment_id={$paymentrow['payment_id']}'><img style='width:20px;' src='myimages/edit.png'>Edit</a>|<a href='display-payment_master.php?did={$paymentrow['payment_id']}'><img style='width:20px;' src='myimages/delete.png'>Delete</a><td>";                        
                            echo "</tr>";
                        }
